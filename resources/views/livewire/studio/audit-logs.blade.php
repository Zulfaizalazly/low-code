<div>
    ...
    <div class="mb-8">
        <div class="flex items-center gap-3 mb-1">
            <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-emerald-500 to-red-600 shadow-sm flex items-center justify-center">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <div class="bg-white rounded-2xl border border-[#1d1d1f]/[0.06] p-5 shadow-sm hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between mb-3">
                ...
                <span class="text-[11px] font-semibold uppercase tracking-wider text-green-600">Staff View</span>
            </div>
