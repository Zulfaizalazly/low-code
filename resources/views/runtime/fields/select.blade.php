<select id="{{ $field->field_key }}"
        ...
        class="block w-full px-4 py-3 rounded-[14px] border border-black/[0.08] bg-[#f9f9fb] focus:bg-white focus:border-green-400 focus:ring-4 focus:ring-green-500/10 transition-all text-[15px] text-[#1d1d1f] appearance-none"
